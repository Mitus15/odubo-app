...
export function brandedEmailHTML({
  ...
  const serif = "'Baskerville', 'Times New Roman', Times, Georgia, serif";
          ...
          <div style="padding:22px 22px 8px 22px;color:${text};font-family:${serif};">
            ...
            <div style="margin:22px 0 6px">
              <a href="${site}/moments?galleryId=${galleryId}"
                 style="display:inline-block;padding:12px 18px;background:${accent};color:#fff;border-radius:999px;text-decoration:none;font-weight:700;font-family:${serif};">
                Open Moments
              </a>
            </div>
          </div>
          <div style="padding:14px 22px 20px 22px;border-top:1px solid #f0ebe3;color:${muted};font-size:12px;font-family:${serif};">
