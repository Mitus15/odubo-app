...
const LegalContent = {
  privacy: (
    <>
      ...
      <p className="mt-3"><strong className="text-[#ede8df]">By buying a ticket and attending, you agree that you may appear on camera and in photographs, and that Odubo Studio and Scott&rsquo;s Inn &amp; Suites may use that material for any purpose, including commercial and promotional use.</strong> In practice that means the album and its artwork, the Loop Soul magazine, video, and promotion of the project and of future volumes. There is no time limit on that use.</p>
      <p className="mt-3">You are told this before you buy, again at the door, and again on the signs in the room. We cannot promise to keep anyone out of shot, and we would rather say so than promise it and fail. Anyone featured as a recognisable subject, rather than as part of the crowd, signs a separate written release on the night.</p>
  ...
  terms: (
    <>
      ...
      <p className="mt-3">By buying a ticket and attending, you agree that you may appear on camera and in photographs, and that Odubo Studio and Scott&rsquo;s Inn &amp; Suites may use that material for any purpose, including commercial and promotional use. The <Link href="/legal?tab=privacy" className="text-[#ede8df] underline underline-offset-2">Privacy Policy</Link> sets out what that means and how to have something taken down.</p>
