...
export default function DesktopSidebar() {
  ...
  const navItems = useMemo(() => {
    ...
    const items = [
      ...
      {
        // The record: its player, and the stem field. Points at /music rather
        // than an album id, so the route decides which album and this entry
        // never needs editing when the next one lands.
        id: 'music',
        label: 'Music',
        href: '/music',
        icon: (
