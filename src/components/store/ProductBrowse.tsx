  ...
  return (
    ...
    >
      ...
      <div className="aspect-square relative">
        ...
        {/* Pre-order badge */}
        {isPreorderActive() && product.available && !isOnSale && (
          <div className="absolute top-2 left-2 px-2 py-0.5 rounded-full bg-black/60 backdrop-blur-sm border border-[#843c2d]/30 text-white text-[9px] uppercase tracking-widest">
            Pre-Order
          </div>
        )}
...
export default function ProductBrowse() {
  ...
  return (
    ...
    >
      ...
      {/* Pre-order banner */}
      {isPreorderActive() && (
        <div className="px-4 py-3 bg-gradient-to-r from-[#843c2d]/15 via-[#a85540]/10 to-[#843c2d]/15 border-b border-[#843c2d]/15 flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-[#ede8df] tracking-wide">YOU&apos;RE EARLY</p>
            <p className="text-[10px] text-[#b2a491] uppercase tracking-wider">Exclusive pre-order pricing</p>
          </div>
          <div className="text-right">
            <p className="text-sm font-bold text-[#ede8df] tabular-nums">{getTimeUntilDrop().days} days</p>
            <p className="text-[9px] text-[#b2a491] uppercase tracking-wider">until July 15</p>
          </div>
        </div>
      )}
