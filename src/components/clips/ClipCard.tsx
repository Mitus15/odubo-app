        ...
        >
          ...
          <button
            ...
            className="group w-11 h-11 flex items-center justify-center rounded-full 
                     ...
                     hover:shadow-[0_12px_40px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-2px_0_rgba(0,0,0,0.4)]
                     active:scale-95 active:shadow-[0_4px_16px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.05),inset_0_2px_4px_rgba(0,0,0,0.5)]
                     transition-all duration-200 ease-out
                     transform-gpu perspective-1000 hover:translate-z-1"
          ...
          >
            {isMuted ? (
              <svg className="w-5 h-5 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] transform transition-transform group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
